...
{ 
   // Overview:  a main.BoundedQueue is a mutable, bounded FIFO data structure
   ...
   {
      if (capacity < 0)
         throw new IllegalArgumentException ("main.BoundedQueue.constructor");
   ...
   {  // Modifies: this
      ...
      if (o == null)
         throw new NullPointerException ("main.BoundedQueue.enQueue");
      else if (size == capacity)
         throw new IllegalStateException ("main.BoundedQueue.enQueue");
      else
      {
         size++;
         elements [back] = o;
   ...
   {  // Modifies: this
      ...
      if (size == 0)
         throw new IllegalStateException ("main.BoundedQueue.deQueue");
      else
      {
         size--;
